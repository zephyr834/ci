...
echo ">>>> Setup Jenkins."
${SCRIPT_DIR}/jenkins-docker/setupJenkins.sh ${GERRIT_ADMIN_UID} ${GERRIT_ADMIN_EMAIL} ${SSH_KEY_PATH} ${LDAP_OU_ACCOUNTS} ${JENKINS_NAME} ${GERRIT_NAME} ${GERRIT_SSH_HOST} ${GERRIT_WEBURL} ${JENKINS_WEBURL} ${NEXUS_REPO} ${LDAP_NAME} ${LDAP_VOLUME} ${SLAPD_DOMAIN}
